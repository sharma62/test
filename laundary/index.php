...
if (isset($_GET["btn"])) {
    ...
    $dry_cleaning = $_GET["dry_cleaning"];
    $laundary = $_GET["laundary"];
    $shoes_cleaning = $_GET["shoes_cleaning"];
    $home_cleaning = $_GET["home_cleaning"];
    $ironing = $_GET["ironing"];
                                ...
                                <form action="index.php" method="get">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            ...
                                            <div class="form-check form-check-inline text-white">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="laundry" />
                                                <label class="form-check-label" for="inlineCheckbox2">Laundry </label>
                                            </div>
